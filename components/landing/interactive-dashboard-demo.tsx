        ...
        {[
          {
            ...
            role: "Speaking",
            avatar: "https://api.dicebear.com/7.x/open-peeps/svg?seed=Sarah&backgroundColor=fef3c7&radius=50",
            bg: "bg-amber-50/60 dark:bg-orange-950/40",
            isSpeaking: true,
          },
          {
            name: "Alex Rivera (Tech Lead)",
            role: "Muted",
            avatar: "https://api.dicebear.com/7.x/open-peeps/svg?seed=Alex&backgroundColor=fef3c7&radius=50",
            bg: "bg-amber-50/60 dark:bg-blue-950/40",
            isSpeaking: false,
          },
          {
            name: "David Kim (Lead Architect)",
            role: "Screen Share",
            avatar: "https://api.dicebear.com/7.x/open-peeps/svg?seed=David&backgroundColor=fef3c7&radius=50",
            bg: "bg-amber-50/60 dark:bg-emerald-950/40",
            isSpeaking: false,
          },
          {
            name: "Elena Rostova (Design)",
            role: "Listening",
            avatar: "https://api.dicebear.com/7.x/open-peeps/svg?seed=Elena&backgroundColor=fef3c7&radius=50",
            bg: "bg-amber-50/60 dark:bg-purple-950/40",
            isSpeaking: false,
          },
        ].map((user, idx) => (
          <div
