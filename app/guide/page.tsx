...
import { modules, moduleGroups as groups } from '@/lib/module-catalogue';
...
export default function PublicUserGuidePage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 mb-20 print:hidden">
        <div className="bg-linear-to-br from-indigo-900 via-gray-900 to-black rounded-[3rem] p-10 md:p-16 relative overflow-hidden shadow-2xl">
          {/* Abstract glow */}
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-black text-white leading-tight mb-6">
                Everything you need to communicate is <span className="text-transparent bg-clip-text bg-linear-to-r from-indigo-400 to-purple-400">built right in.</span>
              </h2>
