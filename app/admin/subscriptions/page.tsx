    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-2 text-sm sm:text-base">Manage all business subscriptions</p>
        </div>
        <button
          onClick={() => {
            setFormData({
          ...
          className="px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors flex items-center justify-center gap-2 shrink-0"
        >
                ...
                <div key={subscription.id} className="p-4">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-sm text-gray-500 mt-0.5">{subscription.plan}</div>
                    </div>
                    <span
                  ...
                  <div className="flex items-center flex-wrap gap-x-3 gap-y-1 mt-3 text-sm text-gray-600">
