            ...
            {/* Header Interface */}
             ...
             <div className="flex-1 overflow-y-auto p-8 md:p-10 space-y-10 custom-scrollbar">
                ...
                <div className="grid grid-cols-2 gap-4">
                   <div className="p-6 bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-[2rem] border border-blue-100">
                      <p className="text-[9px] font-black text-blue-500 uppercase tracking-widest mb-2">Total Managed Capital</p>
                      <p className="text-3xl font-black text-blue-900">${(selectedSupplier.totalSpent / 1000).toFixed(0)}K</p>
                   </div>
                   <div className="p-6 bg-gradient-to-br from-indigo-50 to-indigo-100/50 rounded-[2rem] border border-indigo-100">
                      <p className="text-[9px] font-black text-indigo-500 uppercase tracking-widest mb-2">Historical Orders</p>
                      <p className="text-3xl font-black text-indigo-900">{selectedSupplier.totalOrders}</p>
                   </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                   <div className="p-6 bg-white border-2 border-gray-50 rounded-[2rem] shadow-sm">
                      <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-4">Direct Personnel</p>
                      <div className="flex items-center gap-4">
                         <div className="w-12 h-12 bg-gray-100 rounded-xl flex items-center justify-center text-[10px] font-black text-gray-400">
                            {selectedSupplier.contactPerson.charAt(0)}
                         </div>
                         <div>
                            <p className="font-black text-gray-900">{selectedSupplier.contactPerson}</p>
                            <p className="text-[10px] font-bold text-gray-400">{selectedSupplier.email}</p>
                         </div>
                      </div>
                   </div>
                   <div className="p-6 bg-white border-2 border-gray-200/50 rounded-[2rem] shadow-sm">
                      <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-4">Node Coordinates</p>
                      <div className="flex items-center gap-3">
                ...
                <div className="bg-gray-900 rounded-[2.5rem] p-8 text-white">
                   <div className="grid grid-cols-3 gap-6">
                      <div className="text-center">
                         <p className="text-[8px] font-black text-white/40 uppercase tracking-widest mb-1">Lead Latency</p>
                         <p className="text-xl font-black">{selectedSupplier.leadTime}</p>
                      </div>
                      <div className="text-center border-x border-white/10">
                         <p className="text-[8px] font-black text-white/40 uppercase tracking-widest mb-1">Pay Terms</p>
                         <p className="text-xl font-black">{selectedSupplier.paymentTerms}</p>
                      </div>
                      <div className="text-center">
                         <p className="text-[8px] font-black text-white/40 uppercase tracking-widest mb-1">Min Threshold</p>
                         <p className="text-xl font-black">${selectedSupplier.minimumOrder.toLocaleString()}</p>
                      </div>
                   </div>
                </div>
             </div>
             ...
             <div className="p-8 md:p-10 bg-white/60 border-t border-gray-100 flex items-center gap-3 sticky bottom-0">
                <button 
                  ...
                  className="flex-1 px-8 py-5 bg-blue-500 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl hover:bg-blue-600 transition-all shadow-xl shadow-blue-500/20 flex items-center justify-center gap-3 cursor-pointer"
                >
                  <MessageSquare className="w-4 h-4" />
                  Initiate Comms
                </button>
