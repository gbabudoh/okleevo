...
import {
  ...
  FileText, Sparkles, Send, ArrowUpRight, CheckCircle2
} from 'lucide-react';
    ...
    <div className="min-h-screen space-y-6 pb-24 sm:pb-12 text-slate-900 dark:text-slate-100">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 border border-indigo-200/60 dark:border-indigo-900/40">
                  ...
                  Okleevo Vendor OS v2.0
                </span>
              </div>
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Vendor SLA scorecards, purchase order automation, and supply chain spend velocity analytics.
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl p-4 shadow-xs flex items-center gap-3">
          ...
          <div>
            <p className="text-xl font-extrabold text-slate-900 dark:text-white leading-none">{suppliers.length}</p>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mt-1">Active Partners</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl p-4 shadow-xs flex items-center gap-3">
          ...
          <div>
            <p className="text-xl font-extrabold text-slate-900 dark:text-white leading-none">{currencySymbol}{totalProcurementSpend.toLocaleString()}</p>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mt-1">Gross Spend</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl p-4 shadow-xs flex items-center gap-3">
          ...
          <div>
            <p className="text-xl font-extrabold text-slate-900 dark:text-white leading-none">96.8%</p>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mt-1">On-Time SLA</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl p-4 shadow-xs flex items-center gap-3">
          ...
          <div>
            <p className="text-xl font-extrabold text-slate-900 dark:text-white leading-none">{avgRating} / 5.0</p>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mt-1">Vendor Trust Rating</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 p-3.5 shadow-xs flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between">
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              placeholder="Search by Company Name, Contact Person, or Category..."
              value={searchQuery}
          ...
          <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800/80 p-1 rounded-xl shrink-0">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                viewMode === 'analytics' ? 'bg-white dark:bg-slate-900 text-emerald-600 shadow-xs' : 'text-slate-500'
              }`}
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                viewMode === 'pipeline' ? 'bg-white dark:bg-slate-900 text-amber-600 shadow-xs' : 'text-slate-500'
              }`}
