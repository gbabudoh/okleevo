        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-950 rounded-3xl p-6 sm:p-7 border border-slate-200/80 dark:border-slate-800 shadow-2xs">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4.5">
              {[
                { id: 'collaboration', label: 'Team Messaging & Video Meeting', icon: MessageSquare, category: 'Communication', desc: 'Real-time team messaging, channels, and WebRTC video meetings.' },
