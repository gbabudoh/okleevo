        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "The all-in-one platform for SMEs. 23 integrated modules including invoicing, CRM, staff collaboration, Mail Engine, bookkeeping, and AI tools for just $39/month.",
              "address": {
                "@type": "PostalAddress",
                "addressCountry": "GB"
              },
